...
<div class="rounded-xl p-5 bg-white shadow-lg">
    <h1 class="font-bold text-xl">Dashboard Data Biaya SPP</h1>

    <div class="flex bg-gray-200 my-2 h-0.5 rounded"></div>

    <?php if ($user == 'Admin'): ?>
    <div class="flex flex-col w-[400px]">
        <button class="bg-green-600 inline-block py-2 my-2 w-[100px] text-center text-sm font-bold rounded text-white" onclick="window.location.href='./?p=data_spp&a=add'">Tambah Data</button>
    </div>
    <?php endif ?>
        ...
        <table class="w-full border rounded">
            <thead>
                <tr class="bg-gray-50 border-b">
                    <th class="w-1/6 py-2 border-r text-sm font-bold text-gray-600">No</th>
                    <th class="w-2/6 py-2 border-r text-sm font-bold text-gray-600">Biaya SPP</th>
                    <th class="w-2/6 py-2 border-r text-sm font-bold text-gray-600">Tanggal Berlaku</th>
                    <?php if ($user == 'Admin'): ?>
                    <th class="w-1/6 py-2 border-r text-sm font-bold text-gray-600">Aksi</th>
                    <?php endif ?>
                </tr>
            </thead>
            ...
            <tbody>
                ...
                <tr id="tr_<?= $row['id']; ?>" class="bg-gray-100 text-center border-b text-sm text-gray-600">
                    ...
                    <td class="py-3 border-r">Rp<?= $row['biaya'] ?></td>
